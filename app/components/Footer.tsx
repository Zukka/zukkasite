      ...
      <div className="container p-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex flex-col md:flex-row md:gap-6 gap-2 flex-1 md:justify-center">
          ...
          <div className="flex flex-col">
            <Link className="text-[#ADB7BE] hover:text-white transition-colors" href="/privacyimfree">
              Privacy I&apos;m Free App
            </Link>
            <Link className="text-[#ADB7BE] hover:text-white transition-colors" href="/privacysmartcounter">
              Privacy Smart Counter App
            </Link>
          </div>
          <div className="flex flex-col">
            <Link className="text-[#ADB7BE] hover:text-white transition-colors" href="/privacytouchblock">
              Privacy Touch Block App
            </Link>
            <Link className="text-[#ADB7BE] hover:text-white transition-colors" href="/privacyrecall">
              Privacy Recall App
            </Link>
          </div>
          <div className="flex flex-col">
            <Link className="text-[#ADB7BE] hover:text-white transition-colors" href="/privacybioflow">
              Privacy BioFlow App
            </Link>
